...
describe Jaleb::Data do
  ...
  describe "read" do 
    it "should return a valid document", :vcr do 
      doc = Jaleb::Data.read(FactoryGirl.build(:valid).url)
    end
    
    # This is just a rough indicator of how long a data should take to download
    it "shouldn't take too long" do 
      # benchmark{ doc = Jaleb::Data.read(Factory(:valid_model).url)}.should_not be_slower_than(5.0)
    end    
  end
end  
